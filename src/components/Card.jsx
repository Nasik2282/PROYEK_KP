  ...
  return (
    <div className="card bg-white hover:shadow-2xl rounded-3xl overflow-hidden p-7 pt-0 xl:pb-0 md:pb-0">
      ...
      <div className="card-content text-gray-700 text-base mb-4 pl-14 text-justify">
        ...
        <button className="edit-btn bg-green-500 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-xl bg-transparent  ">
          <Link className="bg-transparent text-white font-bold bg-transparent " to={`${photo.id}`}>Edit</Link>
        </button>
        <button className="delete-btn bg-red-500 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-xl " onClick={() => deletePhoto(photo.id)}>Delete</button>
        </div>
      </div>
    </div>
